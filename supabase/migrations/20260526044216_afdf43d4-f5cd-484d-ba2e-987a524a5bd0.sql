...
-- Migration: Temporarily disable channel join requirement to reduce churn rate
-- The channel check logic is COMMENTED OUT, not deleted. Uncomment to reactivate.
