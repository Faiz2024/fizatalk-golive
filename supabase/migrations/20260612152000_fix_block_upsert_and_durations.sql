-- Migration: Fix Block UPSERTs and Durations
-- =============================================================================

-- 1. Fix submit_partner_report UPSERT
...
BEGIN
  ...
  IF v_new_penalty >= 100 THEN
    ...
    ELSE
      -- NON-PREMIUM: Blokir permanen (15 hari via auto-expire)
...
-- 2. Fix admin_process_media_report UPSERT
