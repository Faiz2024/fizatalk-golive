...
**Catatan dari pertanyaan terbaru**: Sematan dilakukan di chat privat admin dengan bot (chat yang ditunjuk `TELEGRAM_CS_CHAT_ID`), bukan di channel publik maupun grup. Di chat privat tidak ada syarat izin pin khusus — bot bisa langsung menyematkan pesan di chat tersebut.
...
- Uji: buat satu permintaan tarik bonus → cek pesan tersemat di chat privat admin.
